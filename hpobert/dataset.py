...
from hpobert.utils import tokenize_and_preserve_labels, view_all_entities_terminal

import spacy
import srsly
from hpobert.utils import character_annotations_to_spacy_doc, get_iob_labels
...
class HPODataset(Dataset):
	def __init__(self, filename:str) -> None:
		...
		self.tag_values = ['O', 'B-pnt', 'I-pnt'] # TODO: bad handling, need optimization
...
if __name__ == '__main__':
	...
	# Load data
	dataset = HPODataset(p.DATA_FILE)                                                                                                                                                                     
